    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h1 class="text-2xl font-bold mb-4">Mitgliedschaft beantragen</h1>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Mitgliedsbeitrag -->
                        <div class="mt-4">
                            <x-input-label for="mitgliedsbeitrag" :value="__('Den jährlichen Mitgliedsbeitrag kannst du (ab 12,00 €) selbst festlegen. Eine Änderung für das nächste Jahr ist problemlos möglich.')" />
                        ...
                        <div class="mt-4">
                            <label for="agb_akzeptiert" class="inline-flex items-center">
                                ...
                                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">
                                    {{ __('Ich habe die ') }}
                                    <a href="{{ route('satzung') }}" target="_blank" rel="noopener noreferrer" class="underline text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                                        {{ __('Satzung') }}
                                    </a>
                                    {{ __(' gelesen und bin mir über meine Rechte und Pflichten als Mitglied bewusst.') }}
                                </span>
                            </label>
