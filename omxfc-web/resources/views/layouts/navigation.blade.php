            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('images/omxfc-logo.png') }}" alt="OMXFC Logo" class="block h-9 w-auto">
                        </a>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    @else
                        <!-- Login und Register Buttons für nicht eingeloggte Benutzer -->
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white dark:bg-gray-800 w-full absolute left-0 right-0 shadow-md px-4">
